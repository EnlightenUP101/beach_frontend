      ...
      <div className="max-w-screen-2x flex ">
        ...
        <div className='flex-1 relative'>
          <div className='px-10 py-[6.5rem]'>
            ...
            <p className='text-lg '>
            Jara  provides three full meals a day, drinks (both alcoholic and soft), sweet treats and a snack station available throughout the day. Meals are cooked to order, guaranteeing the freshest most delicious cuisine - a fusion of international favourites and locally sourced ingredients – from the land and the sea. The Restaurant Menu serves Lunch and Dinner for our overnight guests with BBQ and Fiesta feasts on nights with higher occupancy. All Menus shown here <span className='bold'>menu.jarabeachresort.com.</span> If you have any special requests / dietary requirements, please let us know ahead of your visit.
            </p>
