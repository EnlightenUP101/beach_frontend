...
// import { apiEndpoints, queryKeys, useDeleteMutation, useGetQuery, usePostMutation } from '@services';
// import { categoryValidationSchema, categoryInitialValues } from '@utils';
// import { useFormikForm } from '@common/hooks';
// import { toast } from 'react-toastify';
// import { CATEGORY_CREATE_ERROR, SUCCESS_TOAST } from '@constants';
...
//               <td className="py-5 px-4 text-sm text-gray-700">{category?.id}</td>
...
//         errors={errors}
//         touched={touched}
//         onOpen={openCreateCategoryModal}
//         setOnOpen={setOpenCreateCategoryModal}
//       />
//     </div>
//   );
// };
